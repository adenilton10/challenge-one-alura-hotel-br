...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {				
				// verificação dos campos se esta vazio
				if(txtDataN.getDate() == null | txtNome.getText().isEmpty() | txtSobrenome.getText().isEmpty() 
						| txtTelefone.getText().isEmpty() | txtNreserva.getText().isEmpty()) {
	...
	private void salvar() {
		...
		Hospede hospede = new Hospede(txtNome.getText(), txtSobrenome.getText(), java.sql.Date.valueOf(dataN), txtNacionalidade.getSelectedItem().toString(), txtTelefone.getText(), txtNreserva.getText());
